...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className="h-6 w-6 text-neutral-800 dark:text-neutral-200" onClick={onClick} />
  ) : (
    <IconMenu2 className="h-6 w-6 text-neutral-800 dark:text-neutral-200" onClick={onClick} />
  );
};
...
export const NavbarLogo = ({
  ...
  return (
    <a href={href} className="relative z-20 flex items-center gap-2 text-lg font-bold">
      {children}
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none text-neutral-600 dark:text-white",
